...
<body>
	...
	<div class="container">
				...
				<tr scope="col">
					...
					<td>
						...
						<c:when test="${now-dto.bDate_long < (1000*60*60*24*3)}">
							${dto.bTitle} <span class="badge badge-success">New</span>
						</c:when>					
						<c:otherwise>
							${dto.bTitle}
						</c:otherwise>
		...
		<!-- Menu -->
		<div class="container" id="table_div2">
		  <nav class="navbar navbar-expand-lg navbar-dark rounded" style="background-color:#b5c5a1;">
		    ...
		    <div class="collapse navbar-collapse" id="navbarsExample09">
		      <ul class="navbar-nav mr-auto">
		        ...
		        <% } else { %>
		          <a class="btn btn-outline-light" href="write_view.jsp">POST</a>
		        <% } %>
    		...
    		<li class="page-item">
    			<c:choose>
					<c:when test="${(page.curPage + 1) > page.totalPage}">
						<a class="page-link" href="list.do?page=${page.curPage}"> &gt; </a>
					</c:when>
					<c:otherwise>
						<a class="page-link" href="list.do?page=${page.curPage + 1}"> &gt; </a>
					</c:otherwise>
     		...
     		<li class="page-item">
     			<a class="page-link" href="list.do?page=${page.endPage}"> &gt;&gt; </a>
    		</li>
  		</ul>
	</nav>
	</div>
