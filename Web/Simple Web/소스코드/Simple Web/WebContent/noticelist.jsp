	...
	<div class="container" id="table_div">
			...
			<c:forEach items="${list}" var="dto">
				<tr scope="col">
					...
					<td>
						...
						<a href="content_view.do?kind=view&bId=${dto.bId}">
						<c:choose>
						<c:when test="${now-dto.bDate_long < (1000*60*60*24*3)}">
							<span class="badge badge-warning">공지</span>&nbsp;&nbsp;${dto.bTitle} <span class="badge badge-success">New</span>
						</c:when>					
						<c:otherwise>
							<span class="badge badge-warning">공지</span>&nbsp;&nbsp;${dto.bTitle}
						</c:otherwise>
						</c:choose>
						</a>
					</td>			
		  ...
		  <nav class="navbar navbar-expand-lg navbar-dark rounded" style="background-color:#b5c5a1;">
		    ...
		    <div class="collapse navbar-collapse" id="navbarsExample09">
		      <ul class="navbar-nav mr-auto">
		        ...
		        <% } else { %>
		          <a class="btn btn-outline-light" href="notice_write_view.jsp">POST</a>
		        <% } %>
		        </li>		        
		      </ul>
    	...
    	<nav aria-label="..."  id="table_div3">
  			<ul class="pagination justify-content-center">
  				<li class="page-item">
					<a class="page-link" href="noticelistlist.do?page=1"> &lt;&lt;</a>
    			</li>
    			...
    			<li class="page-item">
						...
						<c:otherwise>
							<a class="page-link" href="noticelistlist.do?page=${page.curPage - 1}"> &lt;</a>
						</c:otherwise>
					</c:choose>
    			</li>
				...
				<li class="page-item">
					<c:choose>
						<c:when test="${page.curPage == fEach}">
							<a class="page-link" href="noticelistlist.do?page=${fEach}"> ${fEach} </a>
						</c:when>					
						<c:otherwise>
							<a class="page-link" href="noticelistlist.do?page=${fEach}"> ${fEach} </a>
						</c:otherwise>
    		...
    		<li class="page-item">
    			<c:choose>
					<c:when test="${(page.curPage + 1) > page.totalPage}">
						<a class="page-link" href="noticelistlist.do?page=${page.curPage}"> &gt; </a>
					</c:when>
					<c:otherwise>
						<a class="page-link" href="noticelistlist.do?page=${page.curPage + 1}"> &gt; </a>
					</c:otherwise>
     		...
     		<li class="page-item">
     			<a class="page-link" href="noticelistlist.do?page=${page.endPage}"> &gt;&gt; </a>
    		</li>
  		</ul>
	</nav>
	</div>
