...
<head>
    ...
    #modifyform	{ margin-left: 100px; }	
    #modify_menu { color: black; }
    </style>
</head>
<body>
    ...
    <div class="diaplay_left">
		...
		<div class="form-group row">
    		<div class="col-sm-5">
    			<input name="bId" class="form-control" type="hidden" value="${content_view.bId}" readonly>
    		</div>
  		</div>
  		<div class="form-group row">
    		<div class="col-sm-5">
    			<input class="form-control" type="text" placeholder="${content_view.bId}" readonly>
    		</div>
  		</div>
  		<div class="form-group row">
    		<div class="col-sm-5">
    			<input class="form-control" type="text" placeholder="${content_view.bHit}" readonly>
    		</div>
  		</div>
  		<div class="form-group row">
    		<div class="col-sm-5">
    			<input name="bName" class="form-control" type="text" placeholder="${content_view.bName}" readonly>
    		</div>
  		</div>
  		
  		<div class="form-group row">
    		<div class="col-sm-5">
      			<input name="bTitle" class="form-control" type="text" placeholder="${content_view.bTitle}">
    		</div>
  		</div>
  		...
  		<div class="form-group row">
  			<div class="col-sm-5" id="modify_menu">
  				<input class="btn btn-outline-info" type="submit" value="수정">
				<a class="btn btn-outline-secondary text-dark" href="content_view.do?kind=view&bId=${content_view.bId}">취소</a>
				<a class="btn btn-outline-secondary text-dark" href="list.do?page=<%= session.getAttribute("cpage") %>">목록보기</a>
			</div>  		
		</div>
	</form>
    </div>
