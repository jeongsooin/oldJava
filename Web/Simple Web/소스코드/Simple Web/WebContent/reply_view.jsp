...
<body style='background-color:transparent'>
    ...
    <div class="diaplay_left">
    	<form action ="reply.do" method="post" id="reply_form">
		...
		<div class="form-group row">
    		<div class="col-sm-5">
    			<input name="bId" class="form-control" type="text" value="${reply_view.bId}" readonly>
    		</div>
  		</div>
		<div class="form-group row">
    		<div class="col-sm-5">
    			<input name="bHit" class="form-control" type="text" value="${reply_view.bHit}" readonly>
    		</div>
  		</div>
		<div class="form-group row">
    		<div class="col-sm-5">
    			<input name="bName" class="form-control" type="text" value="<%=session.getAttribute("name")%>" readonly>
    		</div>
  		</div>
  		
  		<div class="form-group row">
    		<div class="col-sm-5">
      			<input name="bTitle" class="form-control" type="text" placeholder="${reply_view.bTitle}">
    		</div>
  		</div>
  		
  		<div class="form-group row">
    		<div class="col-sm-5">
	    		<textarea class="form-control" rows="10" name="bContent" id="bContent">${reply_view.bContent}</textarea>
	    		<script>
  		...
  		<div class="form-group row">
  			<div class="col-sm-5">
				...
				<a class="btn btn-outline-secondary" href="list.do" role="button">Cancel</a>
			</div>  		
		</div>
	</form>
    </div>
