  		...
  		<table class="table" id="content_table">
			<thead class="thead">
				<tr class="table_nav" id="content_title">		 
					<th scope="col" colspan="2">#${content_view.bId}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;${content_view.bTitle}</th>
				</tr>
			</thead>
			<tbody>
				<tr scope="col">
					<td scope="col">Writer&nbsp;&nbsp;| ${content_view.bName}</td>
					<td scope="col">Hit | ${content_view.bHit}</td>						
				</tr>
				<tr scope="col">
				...
				%>	
					<td>
						<a class="btn btn-outline-light" href="modify_view.do?kind=modify&bId=${content_view.bId}">수정</a>&nbsp;&nbsp;
						<a class="btn btn-outline-light" href="delete.do?bId=${content_view.bId}">삭제</a>
					</td>
					<td><a class="btn btn-outline-light" href="list.do?page=<%= session.getAttribute("cpage") %>">목록보기</a></td>				
				<%
		  	 		} else {
		  	 			if(session.getAttribute("status") != null) {
		  	 	%>
		  	 		<td>
		  	 			<a class="btn btn-outline-light" href="reply_view.do?bId=${content_view.bId}">답변</a>
		  	 		</td>
		  	 		<td>
		  	 			<a class="btn btn-outline-light" href="list.do?page=<%= session.getAttribute("cpage") %>">목록보기</a>
		  	 		</td>  	 		
		  	 	<%
		  	 			} else {
		  	 	%>	
