      ...
      <div>
      	<div class="container">
			<table width="900" id="tb" cellpadding="0" cellspacing="0" border="1">
				<form action="/MenuModi" method="post" id="reg_frm" enctype="multipart/form-data">
				<input type="hidden" name="MId" value="${dto.MId}">
				<input type="hidden" name="MWriter" value=<sec:authentication property = "name"/>>
					<tr>
					<td>작성자</td>
					...
					<tr>
					<td>메뉴명</td>
					<td><input type="text" id="MENU_NAME" name="MENU_NAME" size="100" value="${dto.MENU_NAME}"> </td>
					</tr>
					
					<tr>
					<td>메뉴가격</td>
					<td><input type = "text" id="MENU_PRICE" name = "MENU_PRICE" size = "50" value="${dto.MENU_PRICE}"></td>
					</tr>
					
					<tr>
					<td>수량</td>
					<td><input type = "text" id="MENU_QTY" name = "MENU_QTY" size = "50" value="${dto.MENU_QTY}"></td>
					</tr>
					
					<tr>
					<td>메뉴코드</td>
					<td><input type = "text" id="MENU_CODE" name = "MENU_CODE" size = "50" value="${dto.MENU_CODE}"></td>
					</tr>
					
					<tr>
					<td>메뉴설명</td>
					<td>
					<textarea name="MENU_DESCRIPTION" id="ir1" cols="80" class="form-control col-11" rows="15">${dto.MENU_DESCRIPTION}</textarea>
						<script type="text/javascript">
										var oEditors = [];
					...
					<tr>
						<td>이미지추가</td>
						<td>
							<textarea name="MENU_IMAGENAME" id="ir1" cols="80" class="form-control col-11" rows="15">
					...
					<input type="hidden" name="MENU_EXTENSION" value="${menuWrite.MENU_EXTENSION}">
					<tr>
						<td colspan = "2">
						<div class="container" style="text-align: center;">
							<input class="btn btn-outline-primary col-2" type = "button" value = "업데이트" onclick ="form_check()"> &nbsp;&nbsp;
							<a class="btn btn-outline-primary col-2" href = "/resMenu">목록보기</a>
						</div>
						</td>
					</tr>
				</form>
