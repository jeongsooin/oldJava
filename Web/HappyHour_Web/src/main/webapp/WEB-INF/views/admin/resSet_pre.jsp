...
<div id="contents_wrap">
    <div class="tab-content" id="nav-tabContent">
      <div>
		...
		<section id="right">
			<p>오전</p> 
			<input type ="button" value = "09:00" id="time">
			<input type ="button" value = "09:30" id="time">
			<input type ="button" value = "10:00" id="time">
			<input type ="button" value = "10:30" id="time"> <br/>
			<input type ="button" value = "11:00" id="time">
			<input type ="button" value = "11:30" id="time">
			<br/>
			<br/>
			<p>오후</p>
			<input type ="button" value = "12:00" id="time">
			<input type ="button" value = "12:30" id="time">
			<input type ="button" value = "13:00" id="time">
			<input type ="button" value = "13:30" id="time"> <br/>
			<input type ="button" value = "14:00" id="time">
			<input type ="button" value = "14:30" id="time">
			<input type ="button" value = "15:00" id="time">
			<input type ="button" value = "15:30" id="time"> <br/>
			<input type ="button" value = "16:00" id="time">
			<input type ="button" value = "16:30" id="time">
			<input type ="button" value = "17:00" id="time">
			<input type ="button" value = "17:30" id="time"> <br/>
		    <input type ="button" value = "18:00" id="time">
			<input type ="button" value = "18:30" id="time">
			<input type ="button" value = "19:00" id="time">
			<input type ="button" value = "19:30" id="time"> <br/>
			<input type ="button" value = "20:00" id="time">
			<input type ="button" value = "20:30" id="time">
			<input type ="button" value = "21:00" id="time">
			<input type ="button" value = "21:30" id="time"> <br/>
			<input type ="button" value = "22:00" id="time">
			<input type ="button" value = "22:30" id="time">
			<input type ="button" value = "23:00" id="time"> <br/>
