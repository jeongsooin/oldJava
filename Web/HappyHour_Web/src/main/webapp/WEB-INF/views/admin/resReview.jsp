...
<body>
<input type="hidden" id="bName" value=<sec:authentication property ="name"/>>
<div id="header_wrap">
	<header>
		<nav id="mainmenu">
			<ul id="logo">
		...
		<c:forEach items="${list2}" var ="dto">
			...
			<tr>
				...
				<td style="text-align:center">
			    	...
			    	<%-- <a href = "member/view?bId=${dto.BId}&kind=view">${dto.BContent }</a> --%>
			    	<c:choose>
				...
				<td id="replyOk" style="text-align:center"> <!-- 답변여부 -->
			...
			<c:if test="${0 eq dto.BStep}">  <!-- step이 0이면 나오게 작업 -->
			<tr>
