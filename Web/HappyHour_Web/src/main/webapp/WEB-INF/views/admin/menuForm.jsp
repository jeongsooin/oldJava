      ...
      <div>
      	<div class="container">
			<table width="900" id="tb" cellpadding="0" cellspacing="0" border="1">
				<form action="/menuWrite" method="post" id="reg_frm" enctype="multipart/form-data">
				<input type="hidden" name="mId" value="${menuWrite.MId}">
				<input type="hidden" name="MWriter" value=<sec:authentication property = "name"/>>
					...
					<tr>
					<td>메뉴명</td>
					<td><input type="text" id="MENU_NAME" name="MENU_NAME" size="100"> </td>
					</tr>
					
					<tr>
					<td>메뉴가격</td>
					<td><input type = "text" id="MENU_PRICE" name = "MENU_PRICE" size = "50"></td>
					</tr>
					
					<tr>
					<td>수량</td>
					<td><input type = "text" id="MENU_QTY" name = "MENU_QTY" size = "50"></td>
					</tr>
					
					<tr>
					<td>메뉴코드</td>
					<td><input type = "text" id="MENU_CODE" name = "MENU_CODE" size = "50"></td>
					</tr>
					
					<tr>
					<td>메뉴설명</td>
					<td>
					<textarea name="MENU_DESCRIPTION" id="ir1" cols="80" class="form-control col-11" rows="15"></textarea>
						<script type="text/javascript">
										var oEditors = [];
					...
					<tr>
						<td>이미지추가</td>
						<td>
							<textarea name="MENU_IMAGENAME" id="ir1" cols="80" class="form-control col-11" rows="15"></textarea>
