...
public class MenuDTO {
    ...
    public static MenuDTO getInstance() { return new MenuDTO(); }

    public MenuDTO() { }

    public MenuDTO(int mid, String menu_name, String menu_description, int menu_price, String menu_imagename, String menu_extension, int menu_code, int menu_qty, String mwriter) {
        this.mid = mid;
