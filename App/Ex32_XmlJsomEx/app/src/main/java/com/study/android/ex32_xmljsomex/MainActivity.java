package com.study.android.ex32_xmljsomex;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void  getJsonData3() {
        ...
        try {
            ...
            JSONArray menuinitArray = popupObject.getJSONArray("menuitem");

            for (int i=0; i < menuinitArray.length(); i++) {
                Log.d(TAG, "value:" + menuinitArray.getJSONObject(i).getString("value"));
                Log.d(TAG, "onclick:" + menuinitArray.getJSONObject(i).getString("onclick"));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
